...
export class UpdateFieldDto {
  ...
  @ValidateIf((o: UpdateFieldDto) => o.options !== undefined && (o.fieldType === 'select' || o.fieldType === 'status'))
  @IsArray()
  @ValidateBy({
    name: 'fieldOptions',
    validator: {
      validate(value: unknown, args?: ValidationArguments) {
        const dto = args?.object as UpdateFieldDto | undefined;
        if (!dto) return false;
  ...
  @IsOptional()
  options?: string[] | { label: string; color: string }[] | null;
